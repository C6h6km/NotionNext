...
const BLOG = {
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '记录爱情故事🥰', // 站点描述，被notion中的页面描述覆盖
